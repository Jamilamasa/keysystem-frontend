...
export const MagicButtonLink = (props: MagicButtonLinkProps) => {
  return (
    <a className={cn(
      ...
      <span className={`px-6 py-3 inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full ${props.variant === "default" && "bg-gradient-to-r from-[#000080] via-[#4169E1] to-[#000080]"} text-2xl font-bold text-white backdrop-blur-3xl ${props.variant === "outline" && "bg-transparent"}`}>
        {props.title}
      </span>
    </a>
  );
